...
<head>
    ...
    <title>REVALUE MOBILE - Privacy Policy</title>
</head>

<body>
    <div class="REVALUE MOBILE-page-data" style="padding-left: 10%; padding-right: 10%;">

        <div class="pagehead">
            <h2>PRIVACY POLICY</h2>
        </div>

        <p>At REVALUE MOBILE, accessible from www.revaluemobile.in, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            REVALUE MOBILE and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in REVALUE MOBILE. This policy is not
        ...
        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when 
            you use our service and the choices you have associated with that data. We use your data to provide and 
        ...
        <p>We collect information about users such as IP addresses, operating system, device type, and other site 
            usage behaviour. </p>
        ...
        <p>&#9679; Communicate with you, either directly or through one of our partners, including for customer service,
        ...
        <p>REVALUE MOBILE follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>Like any other website, REVALUE MOBILE uses 'cookies'. These cookies are used to store information
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of REVALUE MOBILE.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on REVALUE MOBILE, which are sent
        ...
        <p>Note that REVALUE MOBILE has no access to or control over these cookies that are used by third-party
            advertisers.</p>

        <h3>Third Party Privacy Policies</h3>

        <p>REVALUE MOBILE's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
        ...
        <p>REVALUE MOBILE does not knowingly collect any Personal Identifiable Information from children under the
        ...
        <p>We may from time to time update this privacy policy. When we make these updates, we will change the 
            “last updated” date listed below. If we make a material change to this policy in how we use your 
            personal information, we will update users by placing a more prominent notice on our home page before the change. 
