                    ...
                    <div class="tab-content py-3">
                            ...
                            <form class="row g-2" method="POST" action="{{ route('creat_mobile_series') }}"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="Add Mobile Series" name="add_mobile_series">
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                @foreach ($mobile_series as $mobiles)
                                                    <tr>
                                                        <td>{{ $loop->index + 1 }}</td>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ asset('public') . '/' . $mobiles->mobile_series_image }}">
                                                                <img height="50px" width="50px"
                                                                    src="{{ asset('public') . '/' . $mobiles->mobile_series_image }}"
                                                                    alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a href="{{ route('destroy_mobile_series', $mobiles->id) }}">
                        ...
                        <div class="tab-pane fade" id="primaryprofile" role="tabpanel">
                            ...
                            <hr />
							 <div class="row">
                                <div class="col-md-2" >
                                   <a href="{{route('mobile_modules_table_backup')}}"> <button class="btn btn-primary px-3">Export</button></a>
                                </div>
                            </div>
							  <form action="{{route('updateMobileModuleDataFromCSV')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-2">
                                <div class="col-md-3" >
