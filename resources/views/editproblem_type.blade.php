					...
					<div class="card-body">
						...
						<div class="tab-content py-3">
							<div class="tab-pane fade show active" id="primaryhome" role="tabpanel">
								<form class="row g-2" method="POST" action="{{route('update_pc')}}">
                                    {{csrf_field()}}
									<input type="hidden"  name="id"  value="{{$problem_sp->id}}" >
									<div class="col-md-2">
										<label for="inputFirstName" class="form-label">Problem Category</label>
										<input type="text" class="form-control" id="inputFirstName" placeholder="Problem Category" name="problem_category" value="{{$problem_sp->problem_category}}">
									</div>
